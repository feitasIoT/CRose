...
- Support NPM package management without manual dependency installation
    ...
    "data": [
        ...
        "views/crose_automation_views.xml",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'feitas_iot/static/src/js/terminal_action.js',
            'feitas_iot/static/src/js/nr_flow_viewer.js',
            'feitas_iot/static/src/xml/editor_templates.xml',
            'feitas_iot/static/src/xml/overview_templates.xml',
            'feitas_iot/static/src/xml/terminal_templates.xml',
            'feitas_iot/static/src/xml/nr_flow_viewer_templates.xml',
            'feitas_iot/static/src/scss/instance_kanban.scss',
            'feitas_iot/static/src/scss/terminal.scss',
            'feitas_iot/static/src/scss/nr_flow_viewer.scss',
        ],
        'web.assets_frontend': [
